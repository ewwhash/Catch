...
local function decryptDrive(invoke, address, key, nonce, decryptingStatus, lowMemoryStatus)
    ...
    if invoke(address, "list", config.workingDirectory).n == 0 then
